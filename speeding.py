...
def speeding_ticket(speed, is_birthday):
    ...
    # Evaluate the speeding ticket based on speed
...
# Example Test Cases:
print(speeding_ticket(60, False))  # Should return "No Ticket"
print(speeding_ticket(75, False))  # Should return "Small Ticket"
print(speeding_ticket(85, False))  # Should return "Big Ticket"
print(speeding_ticket(65, True))   # Should return "No Ticket"
print(speeding_ticket(40, True))   # Should return "Small Ticket"
